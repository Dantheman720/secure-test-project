 ...
 * 2013-10-24T11:06:49.237-05:00
 * Generated source version: 2.6.6-redhat-3
 * 
 */
@WebServiceClient(name = "HelloService", 
                  wsdlLocation = "http://localhost:8080/secure-test-project/HelloService?wsdl",
                  targetNamespace = "http://helloworld.quickstarts.org/") 
public class HelloService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://helloworld.quickstarts.org/", "HelloService");
    public final static QName TestHello = new QName("http://helloworld.quickstarts.org/", "TestHello");
    static {
        URL url = null;
        try {
